                        ...
                        <li class="sa-nav__section">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--root">
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                    ...
                                    <a class="sa-nav__link" href="{{route('user.dashboard.index')}}"><span class="sa-nav__icon"><svg height="1em" viewbox="0 0 16 16" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                    ...
                                    <a class="sa-nav__link" href="{{route('user.product.index')}}"><span class="sa-nav__icon"><svg height="1em" viewbox="0 0 16 16" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg></span><span class="sa-nav__title">Products List</span></a>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                    ...
                                    <a class="sa-nav__link" href="{{route('user.order.index')}}"><span class="sa-nav__icon"><svg height="1em" viewbox="0 0 16 16" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg></span><span class="sa-nav__title">Orders List</span></a>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                    ...
                                    <a class="sa-nav__link" href="{{route('user.invoice.index')}}"><span class="sa-nav__icon"><i class="fas fa-file-alt"></i></span><span class="sa-nav__title">Invoice</span></a>
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                    ...
                                    <a class="sa-nav__link" href="{{route('user.settings.index')}}"><span class="sa-nav__icon"><svg height="1em" viewbox="0 0 16 16" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg></span><span class="sa-nav__title">Settings</span></a>
