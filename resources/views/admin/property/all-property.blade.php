                    ...
                    <tbody class="t-body">
                        ...
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            <div class="list-thumb">
                              <img class="w-100" src="{{ asset('public/front/images/listings/list-1.jpg')}}" alt="">
                            </div>
                      ...
                      <tr>
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            <div class="list-thumb">
                              <img class="w-100" src="{{ asset('public/front/images/listings/list-2.jpg')}}" alt="">
                            </div>
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                      ...
                      <tr>
                        <th class="active">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            <div class="list-thumb">
                              <img class="w-100" src="{{ asset('public/front/images/listings/list-3.jpg')}}" alt="">
                            </div>
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                      ...
                      <tr>
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            <div class="list-thumb">
                              <img class="w-100" src="{{ asset('public/front/images/listings/list-4.jpg')}}" alt="">
                            </div>
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                      ...
                      <tr>
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            <div class="list-thumb">
                              <img class="w-100" src="{{ asset('public/front/images/listings/list-5.jpg')}}" alt="">
                            </div>
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
