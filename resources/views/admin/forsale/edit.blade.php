  ...
  <div class="row align-items-center pb40">
            <div class="col-lg-12">
              <div class="dashboard_title_area">
                <h2>Add New Property For Sale</h2>
                  ...
                  <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-item1" role="tabpanel" aria-labelledby="nav-item1-tab">
                      <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                        ...
                        @foreach($forsales as $forsale)
                          ...
                          <input type="hidden" name="id" value="{{ $forsale->id }}">
                        <div class="row">
                            <div class="col-sm-12">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Title</label>
                                <input type="text" name="title" class="form-control" value="{{$forsale->title}}" placeholder="Title">
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="mb20">
                                ...
                                <select class="selectpicker" name="secondary_type">
                                    <option value="Multifamily" {{ $forsale->secondary_type == 'Multifamily' ? 'selected' : '' }}>Multifamily</option>
                                    <option value="Industrial" {{ $forsale->secondary_type == 'Industrial' ? 'selected' : '' }}>Industrial</option>
                                    <option value="Mixed Use" {{ $forsale->secondary_type == 'Mixed Use' ? 'selected' : '' }}>Mixed Use</option>
                                    <option value="Retail" {{ $forsale->secondary_type == 'Retail' ? 'selected' : '' }}>Retail</option>
                                    <option value="Restaurant" {{ $forsale->secondary_type == 'Restaurant' ? 'selected' : '' }}>Restaurant</option>
                                    <option value="Office" {{ $forsale->secondary_type == 'Office' ? 'selected' : '' }}>Office</option>
                                    <option value="Land" {{ $forsale->secondary_type == 'Land' ? 'selected' : '' }}>Land</option>
                                </select>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Property Description</label>
                                <textarea cols="30" rows="5" name="property_desc" placeholder="There are many variations of passages.">{{$forsale->property_desc}}</textarea>
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Address</label>
                                <input type="text" name="address" id="autocomplete" class="form-control" value="{{$forsale->address}}" placeholder="Choose Location" required>
                              </div>
                              <div class="mb20" id="latitudeArea" hidden>
                                <label class="heading-color ff-heading fw600 mb10">Latitude</label>
                                <input type="text" id="latitude" name="latitude" value="{{$forsale->latitude}}" class="form-control">
                              </div>
                              <div class="mb20" id="longtitudeArea" hidden>
                                <label class="heading-color ff-heading fw600 mb10">Longitude</label>
                                <input type="text" name="longitude" id="longitude" value="{{'$forsale->longitude'}}" class="form-control">
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-12">
                      ...
                      <div class="col-lg-5">
                          <div class="profile-box position-relative d-md-flex align-items-end mb50">
                            <div class="profile-img position-relative overflow-hidden bdrs12 mb20-sm">
                              <img class="w-100" src="{{ asset('storage/appforsale/thumbnail/'.$forsale->thumbnail_image) }}" alt="">
                      ...
                      <div class="row" id="image-container">
                        @foreach($images as $index => $image)
                          <div class="col-lg-4">
                            <div class="profile-box position-relative d-md-flex align-items-end mb50">
                              <div class="profile-img position-relative overflow-hidden bdrs12 mb20-sm">
                                <img class="w-100" src="{{ asset('storage/appforsale/multiimage/'.$image) }}" alt="">
                                <a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="" aria-label="Delete Item" onclick="deleteImage(event, '{{ $forsale->id }}', {{ $index }})"><span class="fas fa-trash-can"></span></a>
                              </div>
                            </div>
                          </div>
                        @endforeach
                          ...
                          <div class="row">
                            <div class="col-sm-12 col-xl-6">
                              <div class="mb20">
                                ...
                                <input type="text" name="lot_sale_price" class="form-control" placeholder="$1600,000.00" value="{{$forsale->lot_sale_price}}">
                              </div>
                            </div>
                            <div class="col-sm-12 col-xl-6">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Lot Size</label>
                                <input type="text" name=lot_sale_size class="form-control" placeholder="12,000 SF" value="{{$forsale->lot_sale_size}}">
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="mb20">
                                ...
                                <textarea cols="30" rows="5" name="lot_desc" placeholder="There are many variations of passages.">{{$forsale->lot_desc}}</textarea>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                ...
                                <input type="text" name="zoning" class="form-control" placeholder="LI" value="{{$forsale->zoning}}">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Year</label>
                                <input type="text" name="taxes_year" class="form-control" placeholder="2023" value="{{$forsale->taxes_year}}">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Taxes</label>
                                <input type="text" name="taxes_tax" class="form-control" placeholder="$" value="{{$forsale->taxes_tax}}">
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Zoning Description</label>
                                <textarea cols="30" rows="5" name="zoning_desc" placeholder="There are many variations of passages.">{{$forsale->zoning_desc}}</textarea>
                              </div>
                            </div>
                            <div class="col-md-12">
                              <div class="d-sm-flex justify-content-between">
                    ...
                    <div class="tab-pane fade" id="nav-item5" role="tabpanel" aria-labelledby="nav-item5-tab">
                      <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                        ...
                        @php
                          $amentities = [];
                          if (isset($forsale->amentities)) {
                            $amentities = explode(',', $forsale->amentities);
                          }
                        @endphp
...
$(document).ready(function() {
  $('#myform').submit(function(event) {
    ...
    // Send Ajax request
    $.ajax({
      url: "{{ route('admin.forsale.update', ['forsale' => ':forsale']) }}".replace(':forsale', dataId),
      type: 'POST',
      data: formData,
      dataType: 'json',
      ...
      success: function(response) {
        ...
        var thumbnailImageUrl = "{{ asset('storage/appforsale/thumbnail/') }}/" + response.thumbnail_image;
        ...
        for (var i = 0; i < images.length; i++) {
          var imageUrl = "{{ asset('storage/appforsale/multiimage/') }}/" + images[i];
...
function deleteImage(event, dataId, index) {
    ...
    var url = "{{ route('admin.forsale.deleteimage', ['forsale' => ':forsale', 'index' => ':index']) }}";
    url = url.replace(':forsale', dataId).replace(':index', index);
          ...
          if (response.message === 'Image deleted successfully') {
            ...
            if (response.message === 'Image deleted successfully') {
                ...
                for (var i = 0; i < updatedImages.length; i++) {
                    var imageUrl = "{{ asset('storage/appforsale/multiimage/') }}/" + updatedImages[i];
                    var imageElement = $('<div class="col-lg-4"><div class="profile-box position-relative d-md-flex align-items-end mb50"><div class="profile-img position-relative overflow-hidden bdrs12 mb20-sm"><img class="w-100" src="' + imageUrl + '" alt=""><a href="#" class="tag-del" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="" aria-label="Delete Item" onclick="deleteImage(event, \'' + dataId + '\', ' + i + ')"><span class="fas fa-trash-can"></span></a></div></div></div>');
                    imageContainer.append(imageElement);
                }
            }
