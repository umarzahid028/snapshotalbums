                    ...
                    <div class="tab-pane fade show active" id="nav-item1" role="tabpanel" aria-labelledby="nav-item1-tab">
                      <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Address</label><span style="color: red;">*</span>
                        ...
                        <h4 class="title fz17 mb30">Lot Sale Detail</h4>
                          <div class="row">
                            <div class="col-sm-12 col-xl-6">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Price</label><span style="color: red;">*</span>
                                <input type="text" name="lot_sale_price" class="form-control" placeholder="$1600,000.00">
                              </div>
                            </div>
                            <div class="col-sm-12 col-xl-6">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Lot Size</label>
                                <input type="text" name=lot_sale_size class="form-control" placeholder="12,000 SF">
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="mb20">
                                ...
                                <textarea cols="30" rows="5" name="lot_desc" placeholder="There are many variations of passages."></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                ...
                                <input type="text" name="zoning" class="form-control" placeholder="LI">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Year</label>
                                <input type="text" name="taxes_year" class="form-control" placeholder="2023">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Taxes</label>
                                <input type="text" name="taxes_tax" class="form-control" placeholder="$">
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Zoning Description</label>
                                <textarea cols="30" rows="5" name="zoning_desc" placeholder="There are many variations of passages."></textarea>
                              </div>
                            </div>
                            <div class="col-md-12">
                              <div class="d-sm-flex justify-content-between">
                          ...
                          <div class="col-sm-6 col-lg-3 col-xxl-2">
                            <div class="checkbox-style1">
                              <label class="custom_checkbox">Attic
                                <input type="checkbox" name="amentities[]" value="Attic">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Basketball court
                                <input type="checkbox" name="[]" value="Basketball court">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Air Conditioning
                                <input type="checkbox" name="amentities[]" value="Air Conditioning">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Lawn
                                <input type="checkbox" name="amentities[]" value="Lawn">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Swimming Pool
                                <input type="checkbox" name="amentities[]" value="Swimming Pool">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Barbeque
                                <input type="checkbox" name="amentities[]" value="Barbeque">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Microwave
                                <input type="checkbox" name="amentities[]" value="Microwave">
                                <span class="checkmark"></span>
                              </label>
                            </div>
                          </div>
                          <div class="col-sm-6 col-lg-3 col-xxl-2">
                            <div class="checkbox-style1">
                              <label class="custom_checkbox">TV Cable
                                <input type="checkbox" name="amentities[]" value="TV Cable">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Dryer
                                <input type="checkbox" name="amentities[]" value="Dryer">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Outdoor Shower
                                <input type="checkbox" name="amentities[]" value="Outdoor Shower">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Washer
                                <input type="checkbox" name="amentities[]" value="Washer">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Gym
                                <input type="checkbox" name="amentities[]" value="Gym">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Ocean view
                                <input type="checkbox" name="amentities[]" value="Ocean view">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Private space
                                <input type="checkbox" name="amentities[]" value="Private space">
                                <span class="checkmark"></span>
                              </label>
                            </div>
                          </div>
                          <div class="col-sm-6 col-lg-3 col-xxl-2">
                            <div class="checkbox-style1">
                              <label class="custom_checkbox">Lake view
                                <input type="checkbox" name="amentities[]" value="Lake view">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Wine cellar
                                <input type="checkbox" name="amentities[]" value="Wine cellar">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Front yard
                                <input type="checkbox" name="amentities[]" value="Front yard">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Refrigerator
                                <input type="checkbox" name="amentities[]" value="Refrigerator">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">WiFi
                                <input type="checkbox" name="amentities[]" value="WiFi">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Laundry
                                <input type="checkbox" name="amentities[]" value="Laundry">
                                <span class="checkmark"></span>
                              </label>
                              <label class="custom_checkbox">Sauna
                                <input type="checkbox" name="amentities[]" value="Sauna">
                                <span class="checkmark"></span>
                              </label>
                            </div>
                          </div>
  ...
  $('#myform').submit(function(event) {
    ...
    $.ajax({
      ...
      error: function(xhr, status, error) {
        ...
        errorMessage.text('Error: Please fill all required fields.').show();
        
        setTimeout(function() {
          errorMessage.hide();
          // Enable the button and change the text back to "Submit"
