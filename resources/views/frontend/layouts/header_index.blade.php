...
<meta name="keywords" content="images, save images, albums, wedding albums, wed album, create album, event album">
<meta name="description" content="Snapshot Albums">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-auto">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                <li class="visible_list"> <a class="list-item" href="#home"><span class="title">Home</span></a>
                  
                </li>
                <li class="megamenu_style"> <a  class="list-item" href="#how-to-collect"><span class="title">Set Up</span></a>
                 
                </li>
                <li class="visible_list"> <a class="list-item" href="#faqs"><span class="title">FAQ</span></a>
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              @if(Auth::check())
                <a class="login-info d-flex align-items-center" style="color: #C8E2F9;" href="{{ url('/dashboard') }}" role="button"><i class="fat fa-user-circle fz30 me-2"></i> <span class="d-none d-xl-block">Dashboard</span></a>
              @else
              ...
              <!-- <a class="ud-btn add-property menu-btn bdrs60 mx-2 mx-xl-4" href="{{ route('google.login') }}">SIGN UP <i class="fal fa-arrow-right-long"></i></a> -->
      ...
      <div class="header innerpage-style">
        <div class="menu_and_widgets">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            @if(Auth::check())
              <a href="{{ url('/dashboard') }}"><span class="icon fz40 fat fa-user-circle"></span></a>
            @else
              <a href="{{ route('google.login') }}"><span class="icon fz40 fat fa-user-circle"></span></a>
            @endif
          </div>
        </div>
      </div>
